...
from resources.expenses import blp as ExpenseBlueprint
from resources.incomes import blp as IncomeBlueprint
...
def create_app(db_url=None):
  ...
  app.config["JWT_SECRET_KEY"] = "4080220469348841485500591797049413425"
  jwt = JWTManager(app)
